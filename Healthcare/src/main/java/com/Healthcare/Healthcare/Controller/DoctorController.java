...
public class DoctorController {
    ...
    @PostMapping("/customUpdateDoctor")
    public Doctor customUpdate(@RequestBody Doctor doctor) {
        return doctorService.updateDoctorByName(doctor);
    }

    @GetMapping("/customDoctorsByHospital")
    public List<Doctor> customDoctorByHospital(@RequestParam String hospital) {
        return doctorService.customDoctorsByHospital(hospital);
    }
}
