        ...
        <div class="contr">
            <div class="box-container">
                <div class="box"  v-for="doctor in doctors" :key="doctor.id">
                    ...
                    <router-link @click="setDoctor(doctor.user_name, doctor.password)" to="/EditDoctor" class="green-btn">edit</router-link>
                    <button class="red-btn" @click="deleteDoctor(doctor.user_name, doctor.hospital, doctor.department)">delete</button>
                </div>
            </div>
            <router-link to="/AddDoctor" class="green-btn-add">add new doctor</router-link>
        </div> 
        <Footer/>  
</template>
